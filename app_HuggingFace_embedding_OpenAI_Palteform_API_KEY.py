...
# ✅ Initialize OpenAI for GPT Answer Generation
...
if scores:
    ...
    if score_value >= score_threshold:
        ...
        print("\n\033[1;31m❌ Low Match (Similarity < 0.5), GPT will answer your query.\033[0m")
        use_faiss = False

#########################################################################################################################
# ✅ Define System Prompt to Improve GPT Accuracy
system_prompt = """
...
# ✅ Use GPT to Answer the Query Based on Retrieved Context
if not use_faiss:  # ✅ If FAISS is irrelevant, rely **only on GPT**
    prompt = f"{system_prompt}\n\nAnswer the following question based on your knowledge:\n\nQuery: {query}\n\nAnswer:"
    gpt_response = llm.predict(prompt)  # ✅ GPT generates an answer
else:  
...
if use_faiss:
    ...
    # ✅ FAISS is not relevant → Only GPT answer
    print("\n\033[1;36m🤖 **GPT-Generated Answer:**\033[0m\n")
